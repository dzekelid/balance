...
- name: Azure Virtual Network API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/balance/master/_listings/azure-virtual-network/subscriptions-subscriptionid-providers-microsoft-network-loadbalancers-get.md
x-common:
